...
module.exports = class AWSAttachmentsService extends require("./basic-remote.js") {
  /**
    ...
    try {
      ...
      if (!objectStoreCreds) {
        logConfig.withSuggestion('error',
          ...
          'Ensure AWS S3 instance is subscribed and bound for this tenant',
          { tenantID })
        throw new Error(`AWS S3 instance not bound for tenant ${tenantID}`)
      }
