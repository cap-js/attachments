...
const Request = require('@sap/cds/lib/req/request.js')
...
module.exports = class AWSAttachmentsService extends require("./basic") {
   ...
   * @param {*} tenantID - The tenant ID for which to create/retrieve the S3 client
   */
  ...
  /**
   * Uploads one or multiple attachments to S3
