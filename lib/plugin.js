  ...
  if (meta.flavor === "inferred") {
    ...
    cds.linked(csn).forall("Composition", (comp) => {
      if (
        ...
        if (
          targetDef &&
          !targetDef["@Common.SideEffects#attachmentStatusChanged.SourceEvents"]
        ) {
          targetDef[
            "@Common.SideEffects#attachmentStatusChanged.SourceEvents"
          ] = ["attachmentStatusChanged"]
          targetDef[
            "@Common.SideEffects#attachmentStatusChanged.TargetProperties"
          ] = ["status"]
          targetDef[
            "@Common.SideEffects#attachmentStatusChanged.TargetEntities"
          ] = [{ "=": "statusNav" }]
        }
