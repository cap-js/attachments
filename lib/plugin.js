    ...
    if (srv instanceof cds.ApplicationService) {
      Object.values(srv.entities).forEach((entity) => {
        ...
        if (mediaDraftEntities.length) {
          ...
          srv.before(["DELETE", "UPDATE"], entity, AttachmentsSrv.attachDeletionData.bind(this))
          srv.after(["DELETE", "UPDATE"], entity, AttachmentsSrv.deleteAttachmentsWithKeys.bind(this))

          // case: attachments uploaded in draft and draft is discarded
          srv.before("CANCEL", entity.drafts, AttachmentsSrv.attachDraftDiscardDeletionData.bind(this))
          srv.after("CANCEL", entity.drafts, AttachmentsSrv.deleteAttachmentsWithKeys.bind(this))
        }
