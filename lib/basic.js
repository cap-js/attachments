...
module.exports = class AttachmentsService extends cds.Service {
   ...
   * @param {cds.Entity} attachments - The attachment entity
   ...
   * @param {cds.Entity} attachment - The attachment entity
   * @returns 
   */
  ...
  /**
   * Returns the fields to be selected from the attachment entity
   * including the association keys if the attachment entity is associated to another entity
   * @param {cds.Entity} attachments - The attachment entity
   ...
   * @param {cds.Entity} target - The attachment entity to register handlers for
   */
