    ...
    if (profile === 'mtx-sidecar') {
        ...
        if (separateObjectStore === "separate") {
            ...
            ds.after('unsubscribe', async (_, req) => {
                ...
                const objectWithKey = [];
                console.log("Printing the enviornment variable",cds.env.requires)
                console.log("Checking attchments has credentilas or not",cds.env.requires?.attachmentsCredentials);
